...
#define FLASH_HP_DF_BLOCK_KEY             (0x08001640U) /*   1792 B:  0x08001640 - 0x08001D3F */
#define FLASH_HP_DF_BLOCK_CODE_SIGN_PKEY  (0x08001D40U) /*   256 B:   0x08001D40 - 0x08001E3F */
