 ...
 * @retval      FSP_ERR_INVALID_DATA Upon incorrect read data.
...
/*******************************************************************************************************************//**
 * @brief       This function enters XIP (Execute-In-Place) mode.
 * @param       None
 * @retval      FSP_SUCCESS           Upon successful operation.
 * @retval      FSP_ERR_INVALID_DATA  Upon incorrect read data.
 * @retval      Any other error code  From underlying operations.
 **********************************************************************************************************************/
