...
1. Project Overview:
	...
	The two example projects ssi_master_ek_ra4e2_ep and ssi_slave_ek_ra4e2_ep are provided for the the SSI Slave EP, one intended for Master and other for the Slave.
...
5. The user cannot change the configuration from Master to Slave at run time.
	...
	1) The example project ssi_master_ek_ra4e2_ep has Master configuration settings and runs in master mode and the example project ssi_slave_ek_ra4e2_ep has Slave configuration settings and runs in slave mode.
