...
1. Project Overview:
  	...
  	Using a Terminal Program (like Tera Term), the user can provide a value & press enter key to set the intensity of the 
	on-board LED.
	...
	To see the user input values on Serial terminal, enable local echo option.
...
3. Hardware Requirements:
	Supported RA boards: CK-RA6M5, EK-RA2A1, EK-RA2A2, EK-RA2E1, EK-RA2E2, EK-RA2L1, EK-RA4E2, EK-RA4M1, EK-RA4M2, 
			     ...
			     RSSK-RA6T1, FPB-RA8E1, EK-RA4L1, EK-RA8E2
...
4. Hardware Connections:
    	...
    	For EK-RA8M1, EK-RA8D1:
    		RXD MISO PA02 --------> TXD Pin of USB-UART
	...
	For FPB-RA8E1:
    		RXD MISO P602 (J3:05)  --------> TXD Pin of USB-UART
    		TXD MOSI P603 (J3:06)  --------> RXD Pin of USB-UART
    		Common GND    (J3:20)  --------> GND Pin of USB-UART

	For EK-RA4L1:
    		RXD MISO P507 (J1:19)  --------> TXD Pin of USB-UART
    		TXD MOSI P506 (J1:20)  --------> RXD Pin of USB-UART
    		Common GND    (J1:25)  --------> GND Pin of USB-UART

	For EK-RA8E2:
    		RXD MISO P414 (J2:21)  --------> TXD Pin of USB-UART
    		TXD MOSI P415 (J2:22)  --------> RXD Pin of USB-UART
    		Common GND    (J2:39)  --------> GND Pin of USB-UART
﻿
Note:
