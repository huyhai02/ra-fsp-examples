...
1. Project Overview:
   	...
   	For MCK-RA8T1:
   		...
   		1. On power up or RESET, the four user LEDs (LED1, LED2, LED3 and LED4) start blinking at 1 Hz frequency and at 90% intensity. 
  	...
  	For EK-RA8E2:
   		...
   		2. Press the first user button (SW1) on the board to change the blinking frequency of the user LEDs. 
      		   With every press of the first user button (SW1), the frequency will switch from 1 Hz to 5 Hz to 10 Hz and cycle back. 
	  
   		3. Press the second user button (SW2) on the board to change the intensity of the user LEDs. With every press of the 
      		   user button (SW2), the intensity will switch from 90% to 50% to 10% and cycle back. 
