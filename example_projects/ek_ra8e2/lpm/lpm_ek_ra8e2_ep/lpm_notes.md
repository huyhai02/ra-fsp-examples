...
* 1 x Micro USB cable or 1 x Type C USB cable (For MCK-RA6T2, MCK-RA4T1, MCK-RA6T3, MCK-RA8T1, FPB-RA0E1, FPB-RA8E1, EK-RA4L1, EK-RA8E2) or 1 x Mini USB cable (For RSSK-RA6T1) + Additional 1 x Micro USB cable for boards have to use Pmod USBUART. 
...
| configuration.xml > Stacks > g_lpm_deep_sleep Low Power Modes (r_lpm) > Properties > Settings > Property > Module g_lpm_deep_sleep Low Power Modes (r_lpm) > Deep Sleep and Standby Options > Wake Sources > IRQ7 | ☐ | ☑ | Select IRQ7 interrupt as source to cancel deep sleep mode. |
...
| configuration.xml > Stacks > g_lpm_sw_standby Low Power Modes (r_lpm) > Properties > Settings > Property > Module g_lpm_sw_standby Low Power Modes (r_lpm) > Deep Sleep and Standby Options > Wake Sources > IRQ7 | ☐ | ☑ | Select IRQ7 interrupt as source to cancel SW Standby mode. |
...
| configuration.xml > Stacks > g_lpm_deep_sw_standby Low Power Modes (r_lpm) > Properties > Settings > Property > Module g_lpm_deep_sw_standby Low Power Modes (r_lpm) > Deep Standby Options > Cancel Sources > IRQ7 | ☐ | ☑ | Select IRQ7 interrupt as source to cancel Deep SW Standby mode. |
...
|   Module Property Path and Identifier   |   Default Value   |   Used Value   |   Reason   |
|-----------------------------------------|-------------------|----------------|------------|
| configuration.xml > Stacks > g_uart UART (r_sci_b_uart) > Properties > Settings > Property > Module g_uart UART (r_sci_b_uart) > General > Channel | 0 | 4 | Use SCI B UART Channel 4 to print the project log to the host PC. |
...
|   Module Property Path and Identifier   |   Default Value   |   Used Value   |   Reason   |
|-----------------------------------------|-------------------|----------------|------------|
| configuration.xml > Stacks > g_external_irq External IRQ (r_icu) > Properties > Settings > Property > Module g_external_irq External IRQ (r_icu) > Channel | 0 | 7 | Use External IRQ channel 7 to cancel LPM modes. |
