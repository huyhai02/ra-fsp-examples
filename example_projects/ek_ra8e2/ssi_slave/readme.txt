...
1. Project Overview:
     	...
     	The two example projects ssi_master_ek_ra8e2_ep and ssi_slave_ek_ra8e2_ep are provided for the SSI Slave EP,
...
3. Hardware Requirements:
     	Supported RA boards: EK-RA4M2, EK-RA4M3, EK-RA6M1, EK-RA6M2, EK-RA6M3, EK-RA6M4, EK-RA6M5, EK-RA4E2, EK-RA6E2,
                             EK-RA8D1, EK-RA8M1, FPB-RA8E1, EK-RA4L1, EK-RA8E2.
...
4. Hardware Connections:
	...
	Connect the Type-C USB end of the Type-C USB device cable to Debug port of the board.
...
5. Verifying Operation
        ...
        then follow below instructions to observe the operation of the system.
       		1. Connect the Master RA MCU and Slave RA MCU device to host PC via two Type-C USB Cables and connect wires
...
1) The user cannot change the configuration from Master to Slave at run time.
   The example project ssi_master_ek_ra8e2_ep has Master configuration settings and runs in Master mode and the example
   project ssi_slave_ek_ra8e2_ep has Slave configuration settings and runs in Slave mode.

2) Segger RTT block address may be needed to download and observe EP operation using a hex file with RTT-Viewer.
   RTT Block address for hex file committed in repository are as follows:
   a. e2studio: 0x2204086c
