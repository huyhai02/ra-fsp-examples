...
#define MODULE_NAME  "USBX_Host_Hub"
#define BANNER_INFO  "\r\n********************************************************************************"\
...
typedef enum event_id
{
    ...
    RTT_OUTPUT_MESSAGE_APP_PRINT_KEY_PRESS,
    RTT_OUTPUT_MESSAGE_APP_PRINT_LEFT_BUTTON_PRESS,
    RTT_OUTPUT_MESSAGE_APP_PRINT_RIGHT_BUTTON_PRESS,
    RTT_OUTPUT_MESSAGE_APP_PRINT_MOUSE_POSITION,
...
#endif /* RTOS aware RTT data structures and functions */
