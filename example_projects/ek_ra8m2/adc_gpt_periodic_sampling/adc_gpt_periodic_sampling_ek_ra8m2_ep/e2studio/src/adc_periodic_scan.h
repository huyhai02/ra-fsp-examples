...
#define EP_INFO "\r\nThis example project demonstrates the basic functionality of ADC GPT Periodic Sampling\r\n"\
                "on Renesas RA MCUs based on FSP. On successful initialization of ADC, GPT, ELC and DTC\r\n"\
                "modules, GPT triggers an ADC group scan at periodic intervals. When each group scan\r\n"\
                "completes, DTC triggers data transfer and copies data to user buffer. The sample ADC\r\n"\
                "data can be viewed through waveform rendering of memory using memory viewer in e2studio.\r\n\r\n"\
