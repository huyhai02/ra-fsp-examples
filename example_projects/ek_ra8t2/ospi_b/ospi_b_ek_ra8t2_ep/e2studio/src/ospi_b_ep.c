...
#elif defined (BOARD_RA8E2_EK) || defined (BOARD_RA8P1_EK) || defined (BOARD_RA8D2_EK) || defined (BOARD_RA8M2_EK) ||\
...
fsp_err_t ospi_b_set_protocol_to_opi(void)
{
    ...
    else if (SPI_FLASH_PROTOCOL_EXTENDED_SPI == g_ospi_b_ctrl.spi_protocol)
    {
        ...
        /* Change the OCTACLK clock to 100 MHz in DDR mode with OM_DQS */
        octaclk.source_clock = BSP_CLOCKS_SOURCE_CLOCK_PLL2P;
        octaclk.divider      = BSP_CLOCKS_OCTA_CLOCK_DIV_1;
        R_BSP_OctaclkUpdate(&octaclk);
...
/*******************************************************************************************************************//**
 * @brief       This function initializes GPT module used to measure OSPI operation execution time.
 * @param[in]   None.
 * @retval      FSP_SUCCESS Upon successful operation.
 * @retval      Any other error code apart from FSP_SUCCESS  Unsuccessful operation.
 **********************************************************************************************************************/
...
#if defined (BOARD_RA8D1_EK) || defined (BOARD_RA8M1_EK) || defined (BOARD_RA8D2_EK) || defined (BOARD_RA8T2_EK)
