...
#define OSPI_B_DEVICE_ID                    (0x1A5A9D)      /* For IS25LX512M flash */
#endif
...
#endif
#define OSPI_B_APP_ADDRESS(sector_no)       ((uint8_t *)(OSPI_B_CS1_START_ADDRESS +\
											((sector_no) * OSPI_B_SECTOR_SIZE_4K)))
