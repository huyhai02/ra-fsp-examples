...
2) For Keil, please note that a licensed version of Keil is required to build this project and ensure that the
   DLL version matches the required J-Link version before debugging the project. Open project, connect the RA
   board to the host PC, and the DLL version can be found at:
