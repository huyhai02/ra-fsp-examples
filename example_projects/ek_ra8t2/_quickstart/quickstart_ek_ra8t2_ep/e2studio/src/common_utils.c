...
bool_t tolowerstr(char_t *ptr, uint32_t len)
{
    ...
    {
        /* Cast return value of tolower() from int to char_t, as tolower() returns int per C standard
         * but the destination is a char_t character in the string */
...
bool_t toupperstr(char_t *ptr, uint32_t len)
{
    ...
    for (uint32_t i = 0; i < len; i++)
    {
        /* Cast return value of toupper() from int to char_t, as toupper() returns int per C standard
         * but the destination is a char_t character in the string */
