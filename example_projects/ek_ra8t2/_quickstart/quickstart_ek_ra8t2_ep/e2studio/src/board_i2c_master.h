...
extern fsp_err_t wr_sensor_multi_reg16_8 (i2c_master_ctrl_t * p_api_ctrl, int regID, int regDat);
extern fsp_err_t rd_sensor_multi_reg16_8 (i2c_master_ctrl_t * p_api_ctrl, uint16_t regID, uint8_t* regDat, uint32_t len);
