...
fsp_err_t wr_sensor_reg8_8(int regID, int regDat)
{
    ...
    /*  cast to prevent conversion from 'int' to 'unsigned char' that may change value [-Wconversion] */
...
/**********************************************************************************************************************
 End of function rd_sensor_reg16_8
 *********************************************************************************************************************/


/**********************************************************************************************************************
 * Function Name: rd_sensor_multi_reg16_8
 * Description  : Read block of data (specified in bytes) from active i2c target
 * Arguments    : p_api_ctrl - i2c_stack registered in FSP
 *              : regID      - sub address on target device
 *              : regDat     - pointer to data to write
 *              : len        - data length in bytes
 * Return Value : see board_i2c_master_wait_complete.
 *********************************************************************************************************************/
fsp_err_t rd_sensor_multi_reg16_8(i2c_master_ctrl_t * p_api_ctrl, uint16_t regID, uint8_t* regDat, uint32_t len)
{
    fsp_err_t err = FSP_ERR_INVALID_MODE;
...
/**********************************************************************************************************************
 End of function rd_sensor_multi_reg16_8
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * Function Name: wr_sensor_multi_reg16_8 not implemented
 * Description  : Write block of data (specified in bytes) from active i2c target
 * Arguments    : p_api_ctrl - i2c_stack registered in FSP
 *              : regID      - sub address on target device
 *              : regDat     - pointer to data to write
 * Return Value : NONE
 *********************************************************************************************************************/
fsp_err_t wr_sensor_multi_reg16_8(i2c_master_ctrl_t * p_api_ctrl, int regID, int regDat)
{
    fsp_err_t err = FSP_ERR_INVALID_MODE;

    /* Function not implemented on this release */
    UNUSED_PARAM(p_api_ctrl);
    UNUSED_PARAM(regID);
    UNUSED_PARAM(regDat);
...
/**********************************************************************************************************************
 End of function wr_sensor_multi_reg16_8
 *********************************************************************************************************************/
