 ...
 *********************************************************************************************************************/
#define LOCAL_CFG_SWITCH_WARNING_MSG ("\r\nEnsure switch SW4-1 to SW4-8 is set to OFF\r\n")
...
/**********************************************************************************************************************
 End of function board_cfg_switch_init
 *********************************************************************************************************************/
...
void switch_set_status_msg(void)
{
    ...
    {
        sprintf(g_switch_warning_str, LOCAL_CFG_SWITCH_WARNING_MSG);
    }
    else
    {
