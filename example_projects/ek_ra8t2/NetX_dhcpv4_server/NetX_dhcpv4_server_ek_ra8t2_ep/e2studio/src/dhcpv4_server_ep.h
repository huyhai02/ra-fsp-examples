...
#define EP_INFO  "\r\nThis project demonstrates the basic functionality of Netx Duo DHCPv4 server\r\n"\
                 ...
                 "DHCPV4 Server is created and based on user input, the user can start, stop and print\r\n"\
                 "DHCPV4 Clients info. On successful completion of each operation, the success status\r\n"\
                 "is displayed on RTT viewer. The error and info messages will be printed on J-link RTT Viewer.\r\n\n\n"
