...
### Hardware ###
* Supported RA boards: EK-RA6M3, EK-RA6M4, EK-RA6M5, EK-RA8D1, EK-RA8M1, MCK-RA8T1, EK-RA8D2, EK-RA8M2, EK-RA8P1, MCK-RA8T2, EK-RA8T2
...
* For EK-RA8D2, EK-RA8M2, EK-RA8P1:
...
* For MCK-RA8T2:
	...
	* Without ethernet switch:
        * Connect the ethernet port 0 (CN14) of the RA board to the ethernet port of the PC/another RA board running DHCPv4 Client using a LAN cable.
    * With ethernet switch: (Optional)
        * Connect the ethernet port 0 (CN14) of the RA board and the ethernet port of the PC/another RA board running DHCPv4 Client to an ethernet switch using two LAN cables.
...
* For EK-RA8T2:
    ...
    * With ethernet switch: (Optional)
        * Connect the ethernet port 0 (J15) of the RA board and the ethernet port of the PC/another RA board running DHCPv4 Client to an ethernet switch using two LAN cables.
