...
#define EP_INFO     "\r\nThis project demonstrates the basic functionality of USBX Peripheral Mass Storage Class\r\n"\
                    ...
                    "(on board QSPI Flash) to enumerate as a memory drive on host PC. The user can read, write\r\n"\
                    "and perform various file operations on the disk. Application status and any errors will be\r\n"\
                    "printed on the J-Link RTT Viewer.\r\n\n"
#elif defined (BOARD_RA8E2_EK)
#define EP_INFO     "\r\nThis project demonstrates the basic functionality of USBX Peripheral Mass Storage Class\r\n"\
                    "Module running on Renesas RA MCUs based on Renesas FSP using AzureRTOS. RA Board will act\r\n"\
                    "as a device MSC peripheral. The USBX PMSC driver internally configures memory device\r\n"\
                    "(on board OSPI Flash) to enumerate as a memory drive on host PC. The user can read, write\r\n"\
                    "and perform various file operations on the disk. Application status and any errors will be\r\n"\
                    "printed on the J-Link RTT Viewer.\r\n\n"
#else
#define EP_INFO     "\r\nThis project demonstrates the basic functionality of USBX Peripheral Mass Storage Class\r\n"\
                    "Module running on Renesas RA MCUs based on Renesas FSP using AzureRTOS. RA board will act\r\n"\
                    "as a device MSC peripheral. The USBX PMSC driver internally configures memory device\r\n"\
                    "(Block Media SD/MMC) to enumerate as a memory drive on host PC. The user can read, write\r\n"\
                    "and perform various file operations on the disk. Application status and any errors will be\r\n"\
                    "printed on the J-Link RTT Viewer.\r\n\n"
#endif
