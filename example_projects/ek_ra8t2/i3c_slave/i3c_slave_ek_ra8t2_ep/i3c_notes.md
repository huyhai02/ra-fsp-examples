...
Note: EK-RA8D1, EK-RA8P1, EK-RA8D2, EK-RA8M2, EK-RA8T2 boards support I3C HDR-DDR mode. The Master EP can perform write/read operations both in the SDR mode and HDR-DDR mode.
...
### Hardware ###
* Supported RA boards: EK-RA2E2, EK-RA4E2, EK-RA6E2, MCK-RA4T1, MCK-RA6T3, EK-RA8M1, EK-RA8D1, EK-RA4L1, EK-RA2L2, EK-RA8P1, EK-RA8D2, EK-RA8M2, EK-RA8T2.
	* 2 x Renesas RA boards.
	* 2 x Type-C USB cables for programming and debugging.
	* 5 x Jumper wires.
	* 1 x Resistor (1 kΩ, 3.9 kΩ, or 4.7 kΩ) for the SDA pull-up.
		* EK-RA8P1, EK-RA8D2, EK-RA8M2, EK-RA8T2: No external 3.3 V pull-up resistor is required.
...
* The jumper wires are required to establish loop back connection along I3C lines across the board with pins as mentioned below:  
	...
	For EK-RA8P1, EK-RA8D2, EK-RA8M2, EK-RA8T2:
...
## LED Status ##
* The observations of the LED operation on the slave board as below:
...
* For MCK-RA4T1 and MCK-RA6T3, the observations of the LED operation on the slave board as below:
