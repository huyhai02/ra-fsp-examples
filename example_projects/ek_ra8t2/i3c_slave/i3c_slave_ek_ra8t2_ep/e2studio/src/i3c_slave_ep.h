...
#if defined(BOARD_RA8D1_EK) || defined(BOARD_RA8P1_EK) || defined(BOARD_RA8D2_EK) || defined(BOARD_RA8M2_EK) ||\
...
#elif defined(BOARD_RA8D1_EK) || defined(BOARD_RA8M1_EK) || defined(BOARD_RA8P1_EK) || defined(BOARD_RA8D2_EK) ||\
	  defined(BOARD_RA8M2_EK) || defined(BOARD_RA8T2_EK)
