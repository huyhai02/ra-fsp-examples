...
|   Module Property Path and Identifier   |   Default Value   |   Used Value   |   Reason   |
|-----------------------------------------|-------------------|----------------|------------|
| configuration.xml > BSP > Properties > Settings > Property > RA8T2 Family > SDRAM > SDRAM Support | Disabled | Enabled | Initialize SDRAM. |
| configuration.xml > BSP > Properties > Settings > Property > RA8T2 Family > SDRAM > Address Multiplex Shift |	9-bit shift | 10-bit shift | Selects the size of the shift towards the lower half of the row address in row address/column address multiplexing. |
| configuration.xml > BSP > Properties > Settings > Property > RA8T2 Family > SDRAM > Bus Width | 32-bit | 16-bit | Specifies the data bus width for SDRAM. |
...
|   Module Property Path and Identifier   |   Default Value   |   Used Value   |   Reason   |
|-----------------------------------------|-------------------|----------------|------------|
| configuration.xml > BSP > Properties > Settings > Property > RA8D2 Family > Cache setting > Data cache | Disabled | Enabled | Enable Data cache to improve performance. |
