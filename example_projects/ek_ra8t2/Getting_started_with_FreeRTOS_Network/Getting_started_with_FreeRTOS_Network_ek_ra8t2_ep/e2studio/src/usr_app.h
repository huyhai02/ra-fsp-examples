...
#define INNER_HTML_LED_ID       \
                                "\n"\
                                "<div class=\"col-2\"><span class=\"btn %s rounded-circle\" style=\"\
                                ""width: 40px; height: 40px;\"></span ></div>\n"\
 ...
 * application writer to return a constant string, denoting the device's name. */
