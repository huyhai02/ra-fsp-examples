...
4. Hardware Requirements:
   ...
   Supported Boards: EK-RA6M1, EK-RA6M2, EK-RA6M3, MCK-RA6T2, RSSK-RA6T1, MCK-RA4T1, MCK-RA6T3, EK-RA8M1

5. Hardware settings for the project:
	
	1) Connect the micro USB to end of the micro USB device cable to Debug port of the board. Connect the other end of this cable to USB port of the 
	   host PC.

* Note:
1. Segger RTT block address may be needed to download and observe EP operation using a hex file with RTT-Viewer.
   RTT Block address for hex file committed in repository are as follows:
   a. e2studio: 0x220014d0
