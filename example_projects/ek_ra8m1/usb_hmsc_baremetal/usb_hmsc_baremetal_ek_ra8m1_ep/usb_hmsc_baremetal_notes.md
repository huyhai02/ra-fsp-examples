...
|   configuration.xml > rm_freertos_plus_fat > Settings > Property > Module FreeRTOS+FAT port for RA  >  Total number of sectors | 31293440 | 15728640 | Total number of sectors modified based on the connected device |
