...
1) For the functioning of IIC Master on all the boards except for EK-RA8M1, EK-RA8D1, FPB-RA8E1, EK-RA4L1, EK-RA8E2,
   EK-RA4C1, EK-RA8P1, external pull up resistors of value 3.9 or 4.7K ohms are required to be connected on
   I2C (SDA/SCL) lines.﻿
...
6) For EK-RA8P1, MCK-RA8T2: When using SEGGER J-Flash Lite to flash the hex file of the non-secure project
