...
3. Hardware Requirements:
     	Supported RA boards: EK-RA4M2, EK-RA4M3, EK-RA6M1, EK-RA6M2, EK-RA6M3, EK-RA6M4, EK-RA6M5, EK-RA4E2, EK-RA6E2,
                             EK-RA8D1, EK-RA8M1, FPB-RA8E1, EK-RA4L1, EK-RA8E2, EK-RA2L2, EK-RA8P1.
...
5. Verifying Operation:
        ...
        and then follow below instructions to observe the operation of the system.
		   ...
		   sequentially).
			...
			- After the transaction is completed, turn off the Slave first by pressing any key and then for
			  the Master press any key to terminate the process.
		   ...
		   sequentially).
			- Master starts reading and Slave writes and both RA MCUs display the data transaction/messages
			  on J-Link RTT Viewer.
			- After the transaction is completed, turn off the Master first by pressing any key, and then for
			  the Slave press any key to terminate the process.
