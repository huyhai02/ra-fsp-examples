...
3. Hardware Requirements:
	Supported RA boards: EK-RA2A1, EK-RA4M2, EK-RA6M3, EK-RA6M4, EK-RA8D1, EK-RA8M1, MCK-RA8T1, EK-RA4L1,
			     EK-RA8E2, MCK-RA8T2, EK-RA8M2, EK-RA8P1.
...
4. Configuration Settings:
	To select USB Speed in configuration:
		...
		ii. High-Speed: (For EK-RA6M3, EK-RA8M1, EK-RA8D1, EK-RA8M2, EK-RA8P1)
		Setting for r_usb_basic:
...
5. Hardware Connections:
	For EK-RA6M3:
		...
		UART:
			...
			3. When using flow control from Tera Term, the CTS_RST0 P413 should be connected to either
			   RTS (P103) or GND.
