 ...
 * Description  : main() is generated by the RA Configuration editor and is used to generate threads if an RTOS is used.
 ...
 * Description  : This function is called at various points during the startup process. This implementation uses the
 *                event that is called right before main() to set up the pins.
 * Arguments    : event    Where at in the start up process the code is currently at
 * Return Value : None
 **********************************************************************************************************************/
void R_BSP_WarmStart(bsp_warm_start_event_t event)
{
