...
* 1 x USB cable for programming and debugging.
	* Type-C USB cable: MCK-RA6T2, MCK-RA4T1, MCK-RA6T3, MCK-RA8T1, FPB-RA0E1, FPB-RA8E1, EK-RA4L1, FPB-RA0E2, EK-RA8E2, FPB-RA2T1, EK-RA4C1, EK-RA8P1, FPB-RA0L1
...
| FPB-RA0L1 | IRQ0<br>TML32_ITL_OR | IRQ0<br>TML32_ITL_OR | DTC_COMPLETE | DTCENST1_ST33 |
...
| configuration.xml > Stacks > g_external_irq External IRQ (r_icu) > Properties > Settings > Property > Module g_external_irq External IRQ (r_icu) > Digital Filtering | Not Supported | Not Supported | In case board support Digital Filtering, do not use digital filtering in LPM modes. |
...
## Verifying Operation ##
1. Download the example project to the RA board using the USB debug port. J-Link may be disconnected when MCU enters LPM mode. It is recommended to stop debugging after downloading the EP.
