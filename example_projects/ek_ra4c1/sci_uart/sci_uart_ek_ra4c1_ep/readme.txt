...
1. Project Overview:
	...
	Using a Terminal Program (like Tera Term), the user can provide a value and press Enter key to set 
	the intensity of the on-board LED.
	...
	To see the user input values on Serial terminal, enable the local echo option.
...
3. Hardware Requirements:
	Supported RA boards: CK-RA6M5, EK-RA2A1, EK-RA2A2, EK-RA2E1, EK-RA2E2, EK-RA2L1, EK-RA4E2, EK-RA4M1, EK-RA4M2, 
			     ...
			     MCK-RA8T1, RSSK-RA6T1, FPB-RA8E1, EK-RA4L1, EK-RA8E2, EK-RA2L2, EK-RA8P1, FPB-RA2T1, EK-RA4C1
