...
### Hardware ###
* Supported RA boards: EK-RA8M1, EK-RA8D1, MCK-RA8T1, FPB-RA8E1, EK-RA8E2, MCK-RA8T2
  * 1 x RA board.
...
| configuration.xml > Stacks > g_lpm_deep_sw_standby Low Power Modes (r_lpm) > Properties > Settings > Property > Module g_lpm_deep_sw_standby Low Power Modes (r_lpm) > Deep Standby Options > Cancel Sources > ULPT0 Underflow |	☐ | ☑ | Select ULPT0 as source cancel. |
...
| R_IOPORT_PinWrite | This API is used to set the output level for the on-board LED pin. |
| R_IOPORT_PinRead | This API is used to read the level for the on-board LED pin. |

## Verifying Operation ##
1. Import, generate, and build the example project.
2. Flash project binary to the RA board. **Note:** The user should terminate the debugging session and run the example project in standalone mode.
3. Open J-Link RTT Viewer and provide period value for one-shot and periodic timers.

* The images below show J-Link RTT Viewer log:

  ![rtt_viewer_ep_info](images/rtt_viewer_ep_info.jpg "EP information")
