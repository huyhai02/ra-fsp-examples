...
Note:
1) If the user changes the USB speed, the following source code updates are required in addition to the updates described
   in the "Module Configuration Notes" section of the usbx_paud_notes.md file:
