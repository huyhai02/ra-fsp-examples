...
| MCK-RA8T2 | IRQ31-DS<br>ULPT0_ULPTI | IRQ31-DS<br>ULPT0_ULPTI | IRQ31-DS<br>ULPT0_ULPTI | IRQ31-DS<br>ULPT0_ULPTI |
...
| configuration.xml > Stacks > g_lpm_deep_sleep Low Power Modes (r_lpm) > Properties > Settings > Property > Module g_lpm_deep_sleep Low Power Modes (r_lpm) > Deep Sleep and Standby Options > Wake Sources > IRQ31 | ☐ | ☑ | Select IRQ31 interrupt as source to cancel deep sleep mode. |
...
| configuration.xml > Stacks > g_lpm_deep_sw_standby Low Power Modes (r_lpm) > Properties > Settings > Property > Module g_lpm_deep_sw_standby Low Power Modes (r_lpm) > Deep Standby Options > Cancel Sources > IRQ31 | ☐ | ☑ | Select IRQ31 interrupt as source to cancel Deep SW Standby mode. |
...
|   Module Property Path and Identifier   |   Default Value   |   Used Value   |   Reason   |
|-----------------------------------------|-------------------|----------------|------------|
| configuration.xml > Stacks > g_uart UART (r_sci_b_uart) > Properties > Settings > Property > Module g_uart UART (r_sci_b_uart) > General > Channel | 0 | 9 | Use SCI B UART Channel 9 to print the project log to the host PC. |
...
|   Module Property Path and Identifier   |   Default Value   |   Used Value   |   Reason   |
|-----------------------------------------|-------------------|----------------|------------|
| configuration.xml > Stacks > g_external_irq External IRQ (r_icu) > Properties > Settings > Property > Module g_external_irq External IRQ (r_icu) > Channel | 0 | 31 | Use External IRQ channel 31 to cancel LPM modes. |
