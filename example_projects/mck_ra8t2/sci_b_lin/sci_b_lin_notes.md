...
- **SCI B LIN boards:** EK-RA8M1, MCK-RA8T2
...
* Supported RA boards: FPB-RA0E2, EK-RA8M1, MCK-RA8T2
  * 2 x Renesas RA boards.
  * 2 x USB cables:
    * FPB-RA0E2, MCK-RA8T2: 2 x Type-C USB cables.
...
|----|-------------------------------------|-----------------------------------------------------------------------------------|
| 1  | R_SCI_B_LIN_Open | This API is used to configure the LIN driver. |
| 2  | R_SCI_B_LIN_StartFrameWrite | This API is used to begin non-blocking transmission of a LIN start frame (break, sync and protected identifier). |
| 3  | R_SCI_B_LIN_InformationFrameWrite | This API is used to begins non-blocking transmission of a LIN information frame. |
| 4  | R_SCI_B_LIN_InformationFrameRead | This API is used to begin non-blocking information frame reception to receive LIN data. |
| 5  | R_SCI_B_LIN_BaudCalculate | This API is used to calculate baud rate register settings. |
| 6  | R_SCI_B_LIN_Close | This API is used to close the LIN driver. |
| 7  | R_GPT_Open | This API is used to initialize the timer module. |
| 8  | R_GPT_Reset | This API is used to reset the counter value to the period minus one. |
| 9  | R_GPT_PeriodSet | This API is used to set period value provided. |
| 10 | R_GPT_InfoGet | This API is used to get timer information. |
| 11 | R_GPT_Start | This API is used to start timer. |
| 12 | R_GPT_Stop | This API is used to stop timer. |
| 13 | R_GPT_Close | This API is used to close timer module. |
...
The board supports J-Link OB VCOM: EK-RA8M1, FPB-RA0E2, MCK-RA8T2.
