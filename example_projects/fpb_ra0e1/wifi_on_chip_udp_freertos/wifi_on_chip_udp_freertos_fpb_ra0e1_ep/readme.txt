...
4. To run this example project, user needs to compile and download the example project to the evaluation kit and then follow below 
   instructions to observe the operation of the system.
	...
	8) On successful ping which verifies the connection, now connect to the UDP server by providing the IP address and its port number 
           (Eg, UDP server on PC with IP address 192.168.0.177 and Port number 5000)
	...
	11) Message from the MCU can be viewed on PacketSender application. The application depicts the IP address and the Port number 
...
5. Hardware Connections:
	...
	FPB-RA4E1/FPB-RA6E1/EK-RA8M1/EK-RA8D1:
	----------
	connect
