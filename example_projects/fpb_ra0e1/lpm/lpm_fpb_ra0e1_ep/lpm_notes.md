...
**Configuration Properties for SW Standby with Snooze mode LPM instance**
|   Module Property Path and Identifier   |   Default Value   |   Used Value   |   Reason   |
|-----------------------------------------|-------------------|----------------|------------|
...
5. Press the user push-button S1 or wait 10 seconds to enter and cancel LPM mode. It will turn off blue LED before entering each LPM mode and turn on blue LED after exiting each LPM mode.
