...
1. Project Overview:
   ...
   -Quick Start example project that the EK-RA6M1 board comes pre-programmed with. 
   ...
   2. Press the first user button (S1) on the EK-RA6M1 board to change the blinking frequency of the user LED. 
...
4. Hardware settings for the project:
	...
	1. Connect the micro USB end of the micro USB device cable to micro-AB USB (DEBUG USB) 
	   port (J11) of the EK-RA6M1 board.  
	2. Connect the other end of this cable to the USB port of the host PC. Power LED (LED2) 
	   on the EK-RA6M1 board lights up, indicating that the EK-RA6M1 board is powered on. 
	...
	Note:  If the EK-RA6M1 board is not powered through micro-AB USB Full Speed port (J11) 
