...
4. Hardware Connections:
	...
	--------
		...
		VCC pin   (J4:5)  ----> VCC (on Pmod ACL)
		GND pin   (J4:39) ----> GND (on Pmod ACL)
...
1) For the functioning of IIC Master on all the boards except for EK-RA8M1, EK-RA8D1, FPB-RA8E1, EK-RA4L1, EK-RA8E2,
   EK-RA4C1, EK-RA8D2, external pull up resistors of value 3.9 or 4.7K ohms are required to be connected on
   I2C (SDA/SCL) lines.﻿
...
6) For MCK-RA8T2, EK-RA8D2: When using SEGGER J-Flash Lite to flash the hex file of the non-secure project
