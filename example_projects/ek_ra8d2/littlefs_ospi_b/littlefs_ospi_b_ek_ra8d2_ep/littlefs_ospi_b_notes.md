...
- RA boards supported for J-Link OB VCOM: EK-RA8D1, EK-RA8D2.
...
### Hardware ###
Supported RA boards: EK-RA8D1, EK-RA8D2.
...
|   Module Property Path and Identifier   |   Default Value   |   Used Value   |   Reason   |
|-----------------------------------------|-------------------|----------------|------------|
| configuration.xml > BSP > Properties > Settings > Property > RA8D2 Family > Cache settings > Data cache | Disabled | Enabled | Enable Data cache to improve performance. |
