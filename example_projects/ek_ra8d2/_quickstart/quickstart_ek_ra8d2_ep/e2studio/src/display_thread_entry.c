 ...
 *****************************************************************************/
static volatile uint32_t s_vsync_flag = 0;
...
st_rgb565_text_block_page_t gs_page = {
        ...
        " GETTING STARTED          ", /* Title */
        {
            ...
            {{PAGE_LEFT_EDGE, LINE(13) + BLOCK(2)},"Refer to renesas.com and the EK-RA8D2 Quick Start Guide for the full disclaimer text."},
        }
};
...
void display_thread_entry(void *pvParameters)
{
    ...
    fsp_err_t err = FSP_ERR_CLOCK_GENERATION;
