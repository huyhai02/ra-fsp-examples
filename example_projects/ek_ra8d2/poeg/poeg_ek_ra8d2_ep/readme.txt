...
1. Project Overview:
	...
	output pin is disabled successfully. LED1 is turned OFF when POEG resets successfully. Additionally, the user can
...
3. Hardware Requirements:
	Supported RA boards: EK-RA6M1, EK-RA6M2, EK-RA6M3, RSSK-RA6T1, MCK-RA4T1, MCK-RA6T2, MCK-RA6T3, EK-RA8D1,
	                     ...
	                     EK-RA4C1, MCK-RA8T2, EK-RA8M2, EK-RA8D2.
...
2) To verify the EP operation waveform with a Logic Analyzer, see the 'Special Topics' section in
   the poeg_notes.md file.
