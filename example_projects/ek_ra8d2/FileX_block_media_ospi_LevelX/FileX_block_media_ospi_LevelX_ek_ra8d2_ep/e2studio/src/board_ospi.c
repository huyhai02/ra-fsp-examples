...
fsp_err_t ospi_b_init(void)
{
    ...
    {
        RETURN_ERR_STR(FSP_ERR_ABORTED, "Data mismatched in SPI mode\r\n");
    }
#endif
...
#if defined (BOARD_RA8D1_EK) || defined (BOARD_RA8D2_EK)
...
static fsp_err_t ospi_b_set_protocol_to_opi(void)
{
    ...
    else if (SPI_FLASH_PROTOCOL_EXTENDED_SPI == g_ospi_b_ctrl->spi_protocol)
    {
        ...
        {
            RETURN_ERR_STR(FSP_ERR_ABORTED, "Data mismatched in OPI mode!!!\r\n");
        }
#endif
    }
    else
