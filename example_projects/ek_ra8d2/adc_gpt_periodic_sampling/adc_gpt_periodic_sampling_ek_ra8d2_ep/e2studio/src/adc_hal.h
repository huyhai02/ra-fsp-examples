...
#define ADC0_REG                    (R_ADC_B)
#define ADC1_REG                    (R_ADC_B)
#else
#define ADC_TYPE                    "ADC"
#define ADC0_REG                    (R_ADC0)
#define ADC1_REG                    (R_ADC1)
#endif
...
#define ELEVEN                      (11U)  /* ADC channel 11 */
#define TWELVE                      (12U)  /* ADC channel 12 */
#define THIRTEEN                    (13U)  /* ADC channel 13 */
#define FOURTEEN                    (14U)  /* ADC channel 14 */
#define FIVETEEN                    (15U)  /* ADC channel 15 */
