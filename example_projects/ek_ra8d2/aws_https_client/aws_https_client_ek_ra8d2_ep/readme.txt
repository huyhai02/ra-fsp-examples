...
1. Project Overview:
	...
	On GET request, the last MCU die temperature data is read from the adafruit server. J-Link RTT Viewer is used
	to display the status and responses of the requests made to server.
...
2. Hardware Requirements:
	Supported RA boards: EK-RA6M3, EK-RA6M5, EK-RA8M1, EK-RA8D1, MCK-RA8T1, EK-RA8D2.
