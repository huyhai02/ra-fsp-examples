...
5. Press the user push-button S1 or wait 10 seconds to enter and cancel LPM mode. It will turn off LED0 before entering each LPM mode and turn on LED0 after exiting each LPM mode.
