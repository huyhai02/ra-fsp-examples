...
#define EP_INFO        "\r\nThis project demonstrates the basic functionality of USBX Host MSC Module \r\n"\
                       "driver with Azure RTOS + FileX file system running on Renesas RA MCUs based \r\n"\
                       "on Renesas FSP. FileX on USBX uses the underlying USB HMSC driver to perform \r\n"\
                       "different file operations based on user input on the USB storage devices.\r\n"\
