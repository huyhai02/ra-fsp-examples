...
2. Hardware Requirements:
	Supported RA boards: EK-RA4M1, EK-RA2A2, EK-RA4L1, EK-RA4C1.
	1 x Renesas RA board.
	1 x Type-C USB cable for programming and debugging.
	For EK-RA4M1, EK-RA2A2:
		1 x The Segment LCD: Lumex LCD-S401M16KR
		(https://www.mouser.in/datasheet/2/244/lumex_lumx-s-a0001420318-1-1737691.pdf).
		4 x 0.47uF Capacitors.
		Some jumper wires.
	For EK-RA4L1, EK-RA4C1:
		1 x The Segment LCD Board orderable part number: RTKLCDSEG1S00001BE
		(https://www.renesas.cn/zh/document/apn/segment-lcd-application-ra4l1)
...
Note:
1) 1) For EK-RA4C1, EK-RA4L1: In case the user is using SEG4 (P400), please be aware that the pull-up behavior may cause
   ghosting display on the Segment LCD Panel.

2) Segger RTT block address may be needed to download and observe EP operation using a hex file with RTT Viewer.
   RTT Block address for hex file committed in repository are as follows:
   a. e2studio: 0x20000c44
