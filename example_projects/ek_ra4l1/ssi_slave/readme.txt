...
1. Project Overview:
     	...
     	The two example projects ssi_master_ek_ra4l1_ep and ssi_slave_ek_ra4l1_ep are provided for the the SSI Slave EP,
...
3. Hardware Requirements:
     	Supported RA boards: EK-RA4M2, EK-RA4M3, EK-RA6M1, EK-RA6M2, EK-RA6M3, EK-RA6M4, EK-RA6M5, EK-RA4E2, EK-RA6E2,
                             EK-RA8D1, EK-RA8M1, FPB-RA8E1, EK-RA4L1.
...
1) The user cannot change the configuration from Master to Slave at run time.
   The example project ssi_master_ek_ra4l1_ep has Master configuration settings and runs in Master mode and the example
   project ssi_slave_ek_ra4l1_ep has Slave configuration settings and runs in Slave mode.
