...
|configuration.xml > g_uart0 UART (r_sci_uart) > module > general > channel | 0 | 9 | PMOD2 is available on UART channel 9. |
|configuration.xml > g_uart0 UART (r_sci_uart) > Pins > TXD9 | P100 | P203 | Select TX pin. |
|configuration.xml > g_uart0 UART (r_sci_uart) > Pins > RXD9 | P101 | P202 | Select RX pin. |
