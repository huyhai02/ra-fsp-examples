...
### Hardware ###
Supported RA boards: EK-RA6M5, EK-RA6M4
...
|-----------------------------------------|-------------------|----------------|------------|
| configuration.xml > Clocks > Clocks Configuration > OCTASPICLK | OCTASPICLK Disabled | OCTASPICLK Src: PLL | Enable operating clock for OCTASPI module by PLL clock source. |
