...
|configuration.xml > g_uart0 UART (r_sci_uart) > Pins > TXD_MOSI | P101 | P101 | Select TX pin. |
|configuration.xml > g_uart0 UART (r_sci_uart) > Pins > RXD_MISO | P100 | P100 | Select RX pin. |
