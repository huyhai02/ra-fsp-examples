...
instructions to observe the operation of the system.
	...
	Supported Boards: EK-RA6M3, MCK-RA8T1
...
Note : For EK-RA4M3/EK-RA6M4/EK-RA6M5/FPB-RA4E1/FPB-RA6E1/MCK-RA8T1 Provide RTT Block Address in RTT viewer to run the EP.

1) Segger RTT block address may be needed to download and observe EP operation using a hex file with RTT-Viewer.
   RTT Block address for hex file committed in repository are as follows:
   a. e2studio: 0x22003240
