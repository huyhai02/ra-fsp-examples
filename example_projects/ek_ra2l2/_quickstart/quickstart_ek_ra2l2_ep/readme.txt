...
1. Project Overview:
        ...
        The project initializes the USB, ADC and GPIO modules with control via a USB Comm Device class terminal.
...
3. Hardware settings for the project:
        ...
        Link to access Quick Start Guide -  https://www.renesas.com/us/en/document/qsg/ek-ra2l2-quick-start-guide
