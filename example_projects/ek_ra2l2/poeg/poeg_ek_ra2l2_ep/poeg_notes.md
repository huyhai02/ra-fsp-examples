...
| configuration.xml > Stacks > g_timer_pwm1 General PWM (r_gpt) > Properties > Settings > Property > Module g_timer_pwm1 Timer, General PWM (r_gpt) > General > Channel | 0 | 7 | This property is used to channel of GPT. |
...
**POEG Reset Channel 1 J-Link RTT Viewer log**
