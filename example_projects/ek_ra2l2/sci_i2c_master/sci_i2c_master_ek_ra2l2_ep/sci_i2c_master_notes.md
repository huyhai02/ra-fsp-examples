...
| configuration.xml > Stacks > g_sci_i2c_master I2C Master (r_sci_i2c) > Properties > Settings > Property > Module g_sci_i2c_master I2C Master (r_sci_i2c) > Channel | 0 | 1 | Use SCI I2C Master Channel 1 to communicate with the sensor. |
...
| configuration.xml > Stacks > g_sci_i2c_master I2C Master (r_sci_i2c) > Properties > Settings > Property > Module g_sci_i2c_master I2C Master (r_sci_i2c) > Slave Address | 0x00 | 0x1D | Specific slave address of the PmodACL ADXL345. |
| configuration.xml > Stacks > g_sci_i2c_master I2C Master (r_sci_i2c) > Properties > Settings > Property > Module g_sci_i2c_master I2C Master (r_sci_i2c) > Address Mode | 7-Bit | 7-Bit | Specific address mode of the PmodACL ADXL345. |
