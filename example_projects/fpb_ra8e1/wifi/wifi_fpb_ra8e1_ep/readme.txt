...
1. Project Overview:
	...
	in J-Link RTT Viewer and connect. Then it performs ping operation on user entered URL or IP address. If successful,  
...
3. Hardware Requirements:
	...
	- WiFi router Access Point(AP) with internet access. 
          Note: WiFi router AP's credentials should be known.
	- PC or laptop connected to the same WiFi router AP. On PC/laptop, create TCP server and start listening
