...
2. To run this example project, user needs to compile and download the example project to the evaluation kit and then follow below 
   instructions to observe the operation of the system.
	...
	Supported Boards: EK-RA4M3/EK-RA6M3/EK-RA6M3G/EK-RA6M4/EK-RA6M5/FPB-RA4E1/FPB-RA6E1/EK-RA8M1/EK-RA8D1/MCK-RA8T1/EK-RA2A2
...
4. Hardware Requirements:
	  ...
	  5) 1 x Micro USB cable (For MCK-RA8T1: 1 x Type C USB cable)
...
Note : 
1) For EK-RA4M3/EK-RA6M4/EK-RA6M5/FPB-RA4E1/FPB-RA6E1/EK-RA8M1/EK-RA8D1/MCK-RA8T1/EK-RA2A2 Provide RTT Block Address in RTT viewer to run the EP.

2) Segger RTT block address may be needed to download and observe EP operation using a hex file with RTT-Viewer.
   RTT Block address for hex file committed in repository are as follows:
   a. e2studio: 0x20001d24
