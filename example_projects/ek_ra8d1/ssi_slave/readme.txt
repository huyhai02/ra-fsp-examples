...
4. To run this example project, user needs to compile and download the example project to the evaluation kit and then follow below instructions to observe the operation of the system.
   ...
   Supported Boards: EK-RA4M2, EK-RA4M3, EK-RA6M1, EK-RA6M2, EK-RA6M3, EK-RA6M4, EK-RA6M5, EK-RA4E2, EK-RA6E2, EK-RA8M1, EK-RA8D1.
...
5. The user cannot change the configuration from Master to Slave at run time.
	...
	1) The example project ssi_master_ek_ra8d1_ep has Master configuration settings and runs in master mode and the example project ssi_slave_ek_ra8d1_ep has Slave configuration settings and runs in slave mode.
...
6. Hardware settings for the project:
	...
	11) EK-RA8D1                   EK-RA8D1
	   ...
	   GND                 -----> GND
	   EK-RA8D1: User need to turn OFF SW1-3 and SW1-5 to use SSI.
