...
| OSPI Flash (LevelX Data Instance) | This instance is dedicated for runtime read/write/erase operations performed by Azure RTOS LevelX NOR. | r_ospi_b |
...
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > General > DS Auto-calibration Pattern Address | 0x00 | 0x90040000 | 	Address to the auto-calibration pattern in the target flash memory's address space. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Erase Sizes > Sector Erase | 4096 | 262144 | Sector size of the flash device. |
...
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Sector Erase > Command Code |  0xDC | 0xDC | Sector Erase Command of flash device in SPI (1S-1S-1S) protocol mode. |
...
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Sector Erase > Command Code |  0x2121 | 0xDCDC | Sector Erase Command of flash device in SPI (8D-8D-8D) protocol mode. |
...
**Configuration Properties for using OSPI Flash (LevelX Data Instance)**
...
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Sector Erase > Command Code |  0x2121 | 0xDCDC | Sector Erase Command of flash device in SPI (8D-8D-8D) protocol mode. |
