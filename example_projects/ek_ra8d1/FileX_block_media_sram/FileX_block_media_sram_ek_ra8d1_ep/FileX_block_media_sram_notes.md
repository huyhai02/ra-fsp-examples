...
**Configuration Properties for using the Serial Terminal (UART). For EK-RA8M1, EK-RA8D1:**
...
**Configuration Properties for using the Serial Terminal (UART). For MCK-RA8T1:**
