 ...
 * Global variable
 *********************************************************************************************************************/
static ospi_b_instance_ctrl_t * g_ospi_b_ctrl;
static spi_flash_cfg_t g_ospi_b_cfg;
...
static fsp_err_t ospi_b_write_enable(void)
{
    ...
    {
        APP_ERR_RET(FSP_ERR_ABORTED, FSP_ERR_ABORTED, "Write enable FAILED\r\n");
    }
    return err;
}
/***********************************************************************************************************************
...
fsp_err_t ospi_b_init (void)
{
    ...
    {
        APP_ERR_RET(FSP_ERR_ABORTED, FSP_ERR_ABORTED, "Verify CFR2V register data FAILED\r\n");
    }
    ...
    {
        APP_ERR_RET(FSP_ERR_ABORTED, FSP_ERR_ABORTED, "Verify CFR3V register data FAILED\r\n");
    }
    ...
    if (OSPI_B_DATA_CFR4V_REGISTER != (uint8_t)transfer.data)
    {
        ...
        {
            APP_ERR_RET(FSP_ERR_ABORTED, FSP_ERR_ABORTED, "Verify CFR4V register default data FAILED\r\n");
        }
        ...
        if (OSPI_B_DATA_CFR4V_REGISTER != (uint8_t)transfer.data)
        {
            APP_ERR_RET(FSP_ERR_ABORTED, FSP_ERR_ABORTED, "Verify CFR4V register data FAILED\r\n");
        }
    ...
    /* Set active OSPI B context for LittleFS */
    g_ospi_b_ctrl = &g_ospi_b_littlefs_ctrl;
    memset(&g_ospi_b_cfg, RESET_VALUE, sizeof(spi_flash_cfg_t));
    memcpy(&g_ospi_b_cfg, &g_ospi_b_littlefs_cfg, sizeof(spi_flash_cfg_t));
...
static fsp_err_t ospi_b_set_protocol_to_opi(void)
{
    ...
    else if (SPI_FLASH_PROTOCOL_EXTENDED_SPI == g_ospi_b_ctrl->spi_protocol)
    {
        ...
        {
            APP_ERR_RET(FSP_ERR_ABORTED, FSP_ERR_ABORTED, "Verify CFR5V register data FAILED\r\n");
        }
    }
    else
    {
        APP_ERR_RET(FSP_ERR_INVALID_MODE, FSP_ERR_INVALID_MODE, "Flash device do not support this mode\r\n");
    }
