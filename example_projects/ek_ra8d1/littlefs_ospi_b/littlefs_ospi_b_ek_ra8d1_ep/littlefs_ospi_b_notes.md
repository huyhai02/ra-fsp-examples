...
| OSPI Flash (Configuration Instance) | This instance is used during system initialization to configure the flash device, including protocol switching from 1S-1S-1S mode to 8D-8D-8D mode and device parameter setup. | r_ospi_b |
| OSPI Flash (LittleFS Data Instance) | This OSPI instance is dedicated for runtime read, write, and erase operations performed by the LittleFS file system. | r_ospi_b |
...
**Configuration Properties for using OSPI Flash (Configuration Instance)**
...
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > General > Chip Select | CS1 | CS1 | 	Specify the OSPI chip select line to use. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > General > DS Auto-calibration Pattern Address | 0x00 | 0x9001F000 | 	Address to the auto-calibration pattern in the target flash memory's address space. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Erase Sizes > Sector Erase | 4096 | 4096 | Sector size of the flash device. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Erase Sizes > Block Erase | 262144 | 0 | Set Block Erase Size to 0 due to Block Erase is not supported on this Flash. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Read > Command Code | 0x13 | 0x13 | Read Command of flash device in SPI (1S-1S-1S) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Read > Dummy Cycles | 0 | 0 | To disable dummy cycles. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Program > Command Code | 0x12 | 0x12 | Page program command of flash device in SPI (1S-1S-1S) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Program > Dummy Cycles | 0 | 0 | To disable dummy cycles. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Write Enable > Command Code | 0x06 | 0x06 | Write Enable Command of flash device in SPI (1S-1S-1S) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Status Read > Command Code | 0x05 | 0x05 | Status Command of flash device in SPI (1S-1S-1S) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Status Read > Dummy Cycles | 0 | 0 | To disable dummy cycles. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Sector Erase > Command Code |  0xDC | 0x21 | Sector Erase Command of flash device in SPI (1S-1S-1S) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Block Erase > Command Code | 0xDC | 0 | Set Block Erase Command to 0 due to Block Erase is not supported on this Flash. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Chip Erase > Command Code | 0x60 | 0x60 | Chip Erase Command of flash device in SPI (1S-1S-1S) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Protocol Mode | SPI (1S-1S-1S) | SPI (1S-1S-1S) | Select single-bit SPI (1S-1S-1S) as the initial protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Frame Format | Standard | Standard | To use with this command set. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Address Length | 3 bytes | 4 bytes | Select the number of address bytes to be 4 bytes for the initial protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Command Code Length | 1 byte | 1 byte | Number of bytes used for command codes. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode > Status Register | No address | No address | Number of bytes used for addressing the status register. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Read > Command Code | 0xEEEE | 0xEEEE | Read Command of flash device in SPI (8D-8D-8D) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Read > Dummy Cycles | 20 | 20 | Dummy cycles to use between the address and data phase for Read commands. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Program > Command Code | 0x1212 | 0x1212 | Page program command of flash device in SPI (8D-8D-8D) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Program > Dummy Cycles | 0 | 0 | To disable dummy cycles. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Write Enable > Command Code | 0x0606 | 0x0606 | Write Enable Command of flash device in SPI (8D-8D-8D) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Status Read > Command Code | 0x0505 | 0x0505 | Status Command of flash device in SPI (8D-8D-8D) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Status Read > Dummy Cycles | 3 | 3 | Dummy cycles to use between the address and data phase for Status Read commands.  |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Sector Erase > Command Code |  0x2121 | 0x2121 | Sector Erase Command of flash device in SPI (8D-8D-8D) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Block Erase > Command Code | 0xDCDC | 0 | Set Block Erase Command to 0 due to Block Erase is not supported on this Flash. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Chip Erase > Command Code | 0x6060 | 0x6060 | Chip Erase Command of flash device in SPI (8D-8D-8D) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Protocol Mode | Dual data rate OPI (8D-8D-8D) | Dual data rate OPI (8D-8D-8D) | Select Dual data rate OPI (8D-8D-8D) as the initial protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Frame Format | xSPI Profile 1.0 | xSPI Profile 1.0 | To use with this command set. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Address Length | 3 bytes | 4 bytes | Select the number of address bytes to be 4 bytes for the initial protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Command Code Length | 2 bytes | 2 bytes | Number of bytes used for command codes. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Status Register | 4 bytes | 4 bytes | Number of bytes used for addressing the status register. |

**Configuration Properties for using OSPI Flash (LittleFS Data Instance)**
...
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Erase Sizes > Sector Erase | 4096 | 4096 | Sector size of the flash device. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Erase Sizes > Block Erase | 262144 | 0 | Set Block Erase Size to 0 due to Block Erase is not supported on this Flash. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Read > Command Code | 0xEEEE | 0xEEEE | Read Command of flash device in SPI (8D-8D-8D) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Read > Dummy Cycles | 20 | 20 | Dummy cycles to use between the address and data phase for Read commands. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Program > Command Code | 0x1212 | 0x1212 | Page program command of flash device in SPI (8D-8D-8D) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Program > Dummy Cycles | 0 | 0 | To disable dummy cycles. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Write Enable > Command Code | 0x0606 | 0x0606 | Write Enable Command of flash device in SPI (8D-8D-8D) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Status Read > Command Code | 0x0505 | 0x0505 | Status Command of flash device in SPI (8D-8D-8D) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Status Read > Dummy Cycles | 3 | 3 | Dummy cycles to use between the address and data phase for Status Read commands.  |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Sector Erase > Command Code |  0x2121 | 0x2121 | Sector Erase Command of flash device in SPI (8D-8D-8D) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Block Erase > Command Code | 0xDCDC | 0 | Set Block Erase Command to 0 due to Block Erase is not supported on this Flash. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Chip Erase > Command Code | 0x6060 | 0x6060 | Chip Erase Command of flash device in SPI (8D-8D-8D) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Protocol Mode | Dual data rate OPI (8D-8D-8D) | Dual data rate OPI (8D-8D-8D) | Select Dual data rate OPI (8D-8D-8D) as the initial protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Frame Format | xSPI Profile 1.0 | xSPI Profile 1.0 | To use with this command set. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Address Length | 3 bytes | 4 bytes | Select the number of address bytes to be 4 bytes for the initial protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Command Code Length | 2 bytes | 2 bytes | Number of bytes used for command codes. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > Initial Mode Mode > Status Register | 4 bytes | 4 bytes | Number of bytes used for addressing the status register. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Read > Command Code | 0xEEEE | 0xEEEE | Read Command of flash device in SPI (8D-8D-8D) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Read > Dummy Cycles | 20 | 20 | Dummy cycles to use between the address and data phase for Read commands. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Program > Command Code | 0x1212 | 0x1212 | Page program command of flash device in SPI (8D-8D-8D) protocol mode. |
| configuration.xml > Stacks > Properties > g_ospi_b OSPI Flash (r_ospi_b) > Settings > Property > Module g_ospi_b OSPI Flash (r_ospi_b) > Command Set > High-speed Mode > Program > Dummy Cycles | 0 | 0 | To disable dummy cycles. |
...
| configuration.xml > Clocks > Clocks Configuration > OCTASPICLK Src: PLL2P | OCTASPICLK Div /4 | OCTASPICLK Div /4 | Select divisor for operating clock OCTASPICLK. |
