...
1. Project Overview:
	...
	For FPB-RA0E1, FPB-RA0E2, FPB-RA0L1, FPB-RA0E3: In RTT Viewer, the user can enter '1' to initialize the IWDT
	and start the TAU timer. The IWDT counter is refreshed periodically every 1 second when the TAU timer expires.
