...
/* Global variable */
/* Variable to capture timer underflow counts and print IWDT status */
 ...
 * @param[in]   None.
 * @retval      FSP_SUCCESS        Upon successful opening of the TAU module.
 * @retval      Any other error code apart from FSP_SUCCESS  Failed to open.
 **********************************************************************************************************************/
 ...
 * @retval      Any other error code apart from FSP_SUCCESS  Failed to start the timer.
 **********************************************************************************************************************/
...
/*******************************************************************************************************************//**
 * @brief       This function is called when TAU timer's counter wrapped around.
 ...
 * @param[in]   None.
 * @retval      FSP_SUCCESS        Upon successful opening.
 * @retval      Any other error code apart from FSP_SUCCESS  Failed to open.
 **********************************************************************************************************************/
...
/*******************************************************************************************************************//**
 * @brief       This function is called when the GPT timer counter wraps around.
 *              It refreshes the IWDT counter and toggles the LED state.
 * @param[in]   p_args   Pointer to the callback function parameter data (not used).
 * @retval      None.
 **********************************************************************************************************************/
