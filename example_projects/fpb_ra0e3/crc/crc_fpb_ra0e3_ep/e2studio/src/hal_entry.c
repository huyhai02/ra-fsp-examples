...
static fsp_err_t crc_operation(void)
{
    ...
    /* Perform SCI UART (EK-RA4E2, EK-RA6E2, MCK-RA4T1, MCK-RA6T3, EK-RA4L1, EK-RA4C1) loop-back transmission
     * from TX to RX */
    /* Perform SAU UART (FPB-RA0E1, FPB-RA0E2, FPB-RA0L1, FPB-RA0E3) loop-back transmission from TX to RX */
    ...
    /* Wait for TX and RX complete events */
    while ((true != b_uart_txflag) || (true != b_uart_rxflag))
    {
        ...
        if (RESET_VALUE == uart_time_out)
        {
            ...
            APP_ERR_PRINT("** UART TX and RX events not received during UART write or read operation **\r\n");
 ...
 *  @param[IN]     p_args   UART callback parameter.
 *  @retval        None.
 **********************************************************************************************************************/
...
void toggle_led(void)
{
    ...
    VALIDATE_IO_PORT_API(R_IOPORT_PinWrite(g_ioport.p_ctrl, (bsp_io_port_pin_t)g_bsp_leds.p_leds[RESET_VALUE],\
                                           LED_OFF));
}
