...
#define EP_INFO "\r\nThe example project demonstrates the typical use of the CRC HAL module APIs.\r\n"\
                ...
                "mode through SCI interface. If the board does not support snoop mode (EK-RA4E2, EK-RA6E2,\r\n"\
                "MCK-RA4T1, MCK-RA6T3, EK-RA4L1, EK-RA4C1), reception is performed in normal mode through SCI\r\n"\
                "interface. If the board does not support snoop mode (FPB-RA0E1, FPB-RA0E2, FPB-RA0L1, FPB-RA0E3),\r\n"\
                "reception is performed in normal mode through SAU interface. On pressing any key through\r\n"\
                "RTT Viewer, CRC value in normal mode is calculated for 4 bytes of data. The calculated CRC\r\n"\
                "value and input data are transmitted and received through loopback on SCI_UART (except for\r\n"\
                "FPB-RA0E1, FPB-RA0E2, FPB-RA0L1, FPB-RA0E3 which use SAU_UART).\r\n"\
