...
/* External IRQ channel for specific boards */
    ...
    || defined (BOARD_RA8M1_EK) || defined (BOARD_RA8E1_FPB) || defined (BOARD_RA8P1_EK)\
    || defined (BOARD_RA8D2_EK) || defined (BOARD_RA8M2_EK)
...
#define USER_SW_IRQ_NUMBER        (0x08)
    ...
    || defined (BOARD_RA2A2_EK) || defined (BOARD_RA0E1_FPB) || defined (BOARD_RA0E2_FPB)\
    || defined (BOARD_RA2T1_FPB) || defined (BOARD_RA0L1_FPB) || defined (BOARD_RA0E3_FPB)
...
#elif defined (BOARD_RA4E2_EK) || defined (BOARD_RA6E2_EK) || defined (BOARD_RA8E2_EK)
...
#define USER_SW_IRQ_NUMBER        (0x0F)
#elif defined (BOARD_RA8T2_MCK)
#define USER_SW_IRQ_NUMBER        (0x1F)
#else
#define USER_SW_IRQ_NUMBER        (0x03)      /* For EK-RA2L1, EK-RA2E1, MCK-RA8T1, EK-RA2L2 */
#endif
