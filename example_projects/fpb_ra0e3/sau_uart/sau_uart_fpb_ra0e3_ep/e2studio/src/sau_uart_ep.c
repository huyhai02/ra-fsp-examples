 ...
 *  @retval      Any error other than FSP_SUCCESS indicates unsuccessful initialization.
 **********************************************************************************************************************/
static fsp_err_t sau_uart_init(void)
{
    fsp_err_t err = FSP_SUCCESS;
 ...
 *  @retval      FSP_SUCCESS    Upon successful operation.
 *  @retval      Any error other than FSP_SUCCESS indicates indicating unsuccessful transmission.
 **********************************************************************************************************************/
static fsp_err_t sau_uart_send(uint8_t * p_data)
{
    fsp_err_t err = FSP_SUCCESS;
 ...
 *  @param[in]   None.
 *  @retval      FSP_SUCCESS    Upon successful operation.
 *  @retval      Any error other than FSP_SUCCESS indicates unsuccessful operation.
 **********************************************************************************************************************/
static fsp_err_t sau_uart_operation(void)
{
    fsp_err_t err = FSP_SUCCESS;
