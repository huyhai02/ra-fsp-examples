...
| configuration.xml > Stacks > g_sau_uart UART (r_sau_uart) > Properties > Settings > Property > Module g_sau_uart UART (r_sau_uart) > General > Channel | 0 | 1 | Use SAU UART channel 1 to communicate with the terminal application on the host PC. |
