...
- **SAU LIN board:** FPB-RA0E2, FPB-RA0E3 
...
* Supported RA boards: EK-RA8M1, FPB-RA0E2, FPB-RA0E3.
* 2 x RA boards
* 2 x USB cables:
...
* Note:  
  * For FPB-RA0E2: The user must close E46, E47 to use J-Link OB VCOM for Serial Terminal (UART).
  * For FPB-RA0E3: The user must turn OFF S3 to use the on-board debug functionality.
...
| `configuration.xml > Stacks > r_tau > Settings > Property > Module g_lin_master_timeout > General > Period`       | 0x10000           | 200                      | Specify the timer period                       |
| `configuration.xml > Stacks > r_tau > Settings > Property > Module g_lin_master_timeout > General > Period Unit`  | Raw Counts        | Miliseconds           | Define timer period unit                       |
...
| `configuration.xml > Stacks > r_gpt > Settings > Property > Module g_lin_master_timeout > General > Period`           | 0x10000           | 200      | Specify the timer period                       |
| `configuration.xml > Stacks > r_gpt > Settings > Property > Module g_lin_master_timeout > General > Period Unit`      | Raw Counts        | Miliseconds           | Define timer period unit                       |
