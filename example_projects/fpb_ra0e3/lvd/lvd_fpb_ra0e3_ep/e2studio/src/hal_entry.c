...
void hal_entry(void)
{
    ...
    /* Open LVD1 instance to detect voltage raise above threshold value by generating a maskable interrupt */
    ...
    while (true)
    {
        /* Check if voltage has increased above the threshold value. If yes, notify the user */
 ...
 * @param[IN]   None.
 * @retval      FSP_SUCCESS         LED turned ON successfully or no LVD0 reset detected.
 * @retval      Any other value     I/O operation error code returned by R_IOPORT_PinWrite.
 **********************************************************************************************************************/
static fsp_err_t check_reset_status(void)
{
...
#endif
    {
        /* Clear the flag once the value is read */
#if defined (BOARD_RA0E1_FPB) || defined (BOARD_RA0E2_FPB) || defined (BOARD_RA0L1_FPB) || defined (BOARD_RA0E3_FPB)
        /* Do nothing */
#else
