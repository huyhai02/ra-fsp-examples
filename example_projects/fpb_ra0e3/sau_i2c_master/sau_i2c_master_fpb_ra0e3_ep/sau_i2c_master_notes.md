...
* For FPB-RA0E3:
  ...
  |-----------|----------|
  |IRQ4 P109 (J2:2) | INT1 (J1:8) |
  |SCL00 P102 (J2:5) | SCL (J2:1/5) |
  |SDA00 P100 (J2:7) | SDA (J2:2/6) |
  |GND pin | GND (J2:3/7) |
  |VCC pin (3V3) | VCC (J2:4/8) |
...
| configuration.xml > Stacks > g_sau_i2c_master I2C Master (r_sau_i2c) > Properties > Settings > Property > Common > Manual Start-Stop | Disabled | Enabled | Enable Manual Start-Stop. |
...
* FPB-RA0E3 limitations: Enabling printing floats to the RTT Viewer is not required and should be disabled to avoid RAM overflow.
