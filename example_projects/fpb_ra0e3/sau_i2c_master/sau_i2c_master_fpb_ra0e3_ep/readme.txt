...
3. Hardware Requirements:
	...
	2 x Resistors (From 1k to 4.7k ohms) used to pull up the I2C bus.
	1 x Breadboard.
...
4. Hardware Connections:
	...
	--------
		IRQ4  P109 (J2:2)  ----> INT1 (on Pmod ACL J1:8)
		SCL00 P102 (J2:5)  ----> SCL  (on Pmod ACL J2:1/5)
		SDA00 P100 (J2:7)  ----> SDA  (on Pmod ACL J2:2/6)
		GND                ----> GND  (on Pmod ACL J2:3/7)
		VCC pin (3V3)      ----> VCC  (on Pmod ACL J2:4/8)
...
1) For the functioning of the SAU I2C Master:
   ...
   b. The value of the external pull-up resistor depends on the I2C bus speed. In this EP, the I2C bus
      is configured at standard speed of 100 kHz, so the recommended external pull-up resistor value is
      from 1k to 4.7k ohms.

2) FPB-RA0E3 limitations: Enabling printing floats to the RTT Viewer is not required and should be disabled
   to avoid RAM overflow.

3) Segger RTT block address may be needed to download and observe EP operation using a hex file with RTT-Viewer.
   RTT Block address for hex file committed in repository are as follows:
   a. e2studio: 0x20004510
...
5) For GCC ARM Embedded Toolchain (Except for FPB-RA0E3): To enable printing floats to RTT Viewer, edit the
