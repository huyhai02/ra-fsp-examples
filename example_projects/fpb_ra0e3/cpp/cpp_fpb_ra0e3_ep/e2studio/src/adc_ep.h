/***********************************************************************************************************************
 * File Name    : adc_ep.h
 * Description  : Contains class, data structures and functions used in adc_ep.cpp, adc_ep.h.
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
#define BANNER_ADC      "\r\nThe example project demonstrates some features of C++ such as class, constructors,\
                         \r\ndestructor, member functions using ADC HAL module APIs provided by FSP.\
                         \r\nThe ADC module is wrapped into a class. An ADC object of this class is instantiated\
                         \r\nand is used to call respective member functions. The project initializes the ADC in\
                         \r\nOne-shot or Sequential modes based on user selection in RA Configurator.\
                         \r\nOnce initialized, the user can initiate the ADC scan and also stop the scan (in the\
                         \r\ncase of Sequential mode) using J-Link RTT Viewer by sending commands. Result and\
                         \r\nADC status are displayed on the J-Link RTT Viewer.\r\n"
#else
#define MENUOPTIONS     "\r\nMENU to Select\
                         \r\nPress 1 to Start ADC Scan\
...
#define BANNER_ADC      "\r\nThe example project demonstrates some features of C++ such as class, constructors,\
                         ...
                         \r\nThe ADC module is wrapped into a class. An ADC object of this class is instantiated\
                         \r\nand is used to call respective member functions. The project initializes the ADC in\
                         \r\nSingle Scan or Continuous Scan modes based on user selection in RA Configurator.\
                         \r\nOnce initialized, the user can initiate the ADC scan and also stop the scan (in the\
                         \r\ncase of Continuous Scan mode) using J-Link RTT Viewer by sending commands. Result and\
                         \r\nADC status are displayed on the J-Link RTT Viewer.\r\n"
#endif
