...
/*******************************************************************************************************************//**
 * @brief       This function reads the command input from RTT and processes it.
 * @param[IN]   None
...
fsp_err_t adc_ep::adc_scan_start(void)
{
    ...
    if (false == g_ready_to_read)
    {
        ...
        /* Set internal temperature sensor as output, the initial conversion result cannot be used.
...
/*******************************************************************************************************************//**
 * @brief       This function reads ADC output data from the specified channel and checks the ADC status.
 * @param[in]   None.
...
/*******************************************************************************************************************//**
 * @brief       This function opens the ADC driver.
 * @param[in]   None.
...
/*******************************************************************************************************************//**
 * @brief       This function closes the ADC driver and handles any errors returned by the closing API.
 * @param[in]   None.
 * @retval      None.
 **********************************************************************************************************************/
...
#if defined(BOARD_RA2A1_EK) || (BSP_PERIPHERAL_ADC_B_PRESENT)
/*******************************************************************************************************************//**
 * @brief       This function initiates ADC calibration.
 * @param[in]   None.
 ...
 *              If the deviation is observed consistently and exceeds the set limit, calibration is triggered again.
 * @param[in]   None.
