...
/* Macros for options to be displayed */
#define MENUOPTION1 "\r\nMENU to Select\r\n"
...
/* Read the commands from RTT Viewer input and process it */
...
#if (BSP_PERIPHERAL_ADC_D_PRESENT)
/* Extend configuration to check scan mode */
...
#define ADC_CHANNEL                 (ADC_CHANNEL_9)
      ...
      || defined(BOARD_RA0L1_FPB) || defined(BOARD_RA8T2_MCK) || defined(BOARD_RA8M2_EK)
#define ADC_CHANNEL                 (ADC_CHANNEL_2)
#elif defined(BOARD_RA6T2_MCK)
#define ADC_CHANNEL                 (ADC_CHANNEL_TEMPERATURE)
#elif defined(BOARD_RA2A1_EK) || defined(BOARD_RA8P1_EK) || defined(BOARD_RA0E2_FPB)
...
/* Macro for printing acceleration value to RTT Viewer without using floating-point print */
#define STR_SIZE                    (10U)

/* Macros for round number */
#define DECIMALS                    (2.0F)
#define ZERO_THRESHOLD              (1.0F / powf(10.0F, DECIMALS))
#define ROUND                       (0.5F * ZERO_THRESHOLD)
#endif
